...
export const About = () => {
    ...
    return (
        <section className="h-full flex flex-col items-center justify-center gap-4 md:gap-6 px-2 md:px-0 mb-20 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-300 rounded-2xl  p-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center items-center w-full">
                <div className="flex flex-col gap-4 md:gap-6 w-full md:w-1/2">
                    ...
                    <button onClick={handleDownload} className="bg-blue-600 dark:bg-blue-500 text-white p-3 md:p-2 rounded-md flex items-center gap-2 w-full md:w-1/3 justify-center cursor-pointer hover:bg-blue-700 dark:hover:bg-blue-400 border-2 border-blue-700 dark:border-blue-400 mx-auto md:mx-0 transition-colors duration-200 shadow md:mb-16">
