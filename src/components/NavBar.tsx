    ...
    return (
        <section className="md:hidden">
            ...
            >
                ...
                <nav className={`absolute top-0 right-0 w-64 h-full shadow-lg p-6 border-l-2 border-blue-200 dark:border-blue-700 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}>
                        ...
                        <div className="flex gap-3 self-center mt-10">
                            <div>
                                <a href="https://www.linkedin.com/in/samuel-muzy-fernandes-a19271269/" target="_blank" rel="noopener noreferrer">
                                    <FaLinkedin className="w-10 h-10 text-blue-500 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-400 transition-colors cursor-pointer" />
                                </a>
                            </div>
                            <div>
                                <a href="https://github.com/samuelmuzy" target="_blank" rel="noopener noreferrer">
                                    <FaGithub className="w-10 h-10 text-blue-500 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-400 transition-colors cursor-pointer" />
                                </a>
                            </div>
                            <div>
                                <a href="https://www.instagram.com/samuelmuzyfernandes/" target="_blank" rel="noopener noreferrer">
                                    <FaInstagram className="w-10 h-10 text-blue-500 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-400 transition-colors cursor-pointer" />
                                </a>
                            </div>
                        </div>
                    </div>
